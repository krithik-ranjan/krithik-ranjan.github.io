  ...
  return (
    <div className='App'>
      ...
      <div className="Nav-menu">
        <div className="Nav-item">PROJECTS</div><div>&#9671;</div>
        <div className="Nav-item">PUBLICATIONS</div><div>&#9671;</div>
        <div className="Nav-item">PHOTOS</div><div>&#9671;</div>
      </div>
      ...
      <div className='Project-grid'>
        ...
        <div className='Project'>
          <div className="Project-image">
              <img src={Cartoonimator}  alt="The Rug Experience" />
          </div>
          <div className="Project-info">
              <h4>Rig-A-Doodle &#9671;</h4>
              <p>Tangible toolkit for character-rigging of hand-drawings.</p>
          </div>
        </div>
        <div className='Project'>
          <div className="Project-image">
          ...
          <div className="Project-info">
              <h4>CV-driven Physical Computing &#9671;</h4>
              <p>Platform integrating electronics and CV approaches for designing physical interactions.</p>
          </div>
        </div>
      </div>
